...
class miescatter:
    ...
    #    a = self.ps
        ...
        def mie_theta(ITH,a_range):
            """
            Calculate Mie scattering parameters for a given scattering angle. 
            For calculation algorithm please refer to the Mie theory documentation by Shah 1977 (pl. see the reference list in the paper).

            Parameters
            ----------
            ITH : int
                Scattering angle index (1-based).
            a_range : float, int, or list
                Particle size or range of sizes.
            """
            SSS1=0.0
            SSS2=0.0
            tot_freq=0.0
